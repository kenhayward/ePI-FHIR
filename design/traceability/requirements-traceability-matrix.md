...
| CAP-RND-007 | 13 | M | P2 | Rendering Service | 3 | partial | CAP_RND_007 and IT_019: two renders of one label version and render-template version are byte-identical, in HTML and in PDF against the engine that writes the bytes. Verified to discriminate - with normalisation removed the case fails |
