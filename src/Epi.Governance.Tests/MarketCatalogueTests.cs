...
public sealed class MarketCatalogueTests : IDisposable
{
    ...
    {
        Write("bad.json", """{"code": "GB", "name": "", "regulator": "MHRA", "languages": ["en-GB"], "affiliates": ["uk"]}""");
    ...
    {
        Write("bad.json", """{"code": "GB", "name": "United Kingdom", "regulator": "MHRA", "languages": [], "affiliates": ["uk"]}""");
    ...
    {
        Write("one.json", """{"code": "", "name": "One", "regulator": "R", "languages": ["en"], "affiliates": ["a"]}""");
        Write("two.json", """{"code": "IE", "name": "Two", "regulator": "", "languages": ["en"], "affiliates": ["a"]}""");
